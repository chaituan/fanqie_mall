...
<body>
	<div class="app app-header-fixed" style="padding-top: 10%;">
		<div class="container w-xxl w-auto-xs animated fadeInRight" ng-controller="SigninFormController" ng-init="app.settings.container = false;">
			...
			<a class="navbar-brand block m-t"><?php echo SHOP_NAME;?></a>
			<div class="m-b-lg">
				<form id="loginform" class="form-validation">
					<div class="text-danger wrapper text-center" ng-show="authError"></div>
					<div class="list-group list-group-sm">
						<div class="list-group-item">
							<input type="text" placeholder="手机号码"  dtype='mobile' name="username" class="form-control no-border" required>
						</div>
						<div class="list-group-item">
							<input type="password" placeholder="密码" name="password" class="form-control no-border" required>
						</div>
					</div>
					<a class="btn btn-lg btn-primary btn-block ajaxproxy" id="login" href="<?php echo site_url("shop/login/sub")?>" proxy='{"method":"post", "formId":"loginform","location":"<?php echo site_url("shop/center/index")?>"}'> 登 录 </a>
					<div class="line line-dashed"></div>
				</form>
			</div>
			<div class="text-center" ng-include="'tpl/blocks/page_footer.html'">
				<p>
					<small class="text-muted"><?php echo COMPANY;?></small>
				</p>
				<p><small class="text-muted">客服微信：chaituan<br>&copy; 2016 - 2017 </small></p>
			</div>
		</div>
	</div>

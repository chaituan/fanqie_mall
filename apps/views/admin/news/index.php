					...
					<div class="table-responsive">
						...
						<?php if (empty($items)){ ?>
							...
							<tr id="list_<?php echo $v['id']?>">
									...
									<td>
									<a href="<?php echo site_url('adminct/news/edit/id-'.$v['id']); ?>" class="btn btn-xs btn-primary"><i class="fa fa-fw fa-pencil"></i></a> 
									<a href="<?php echo site_url('adminct/news/delete/id-'.$v['id']); ?>" class="btn btn-xs btn-danger delone"><i class="fa fa-fw fa-times"></i></a>
									</td>
								</tr>
						<?php }}?>
	                  </tbody>

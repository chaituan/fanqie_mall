	...
	<div class="app app-header-fixed ">
		<header id="header" class="app-header navbar" role="menu">
			...
			<div class="navbar-header bg-dark">
				...
				<!-- brand -->
				<a href="/adminct/manager/index" class="navbar-brand text-lt"> <!--           <i class="fa fa-btc"></i> --> <img src="<?php echo IMG_PATH.'adminloginlogo.png';?>" style="max-height: 25px;"> <span class="hidden-folded m-l-xs"><?php echo SITE_NAME;?></span>
				</a>
				<!-- / brand -->
			</div>
			<!-- / navbar header -->
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle clear" data-toggle="dropdown"> <span class="thumb-sm avatar pull-right m-t-n-sm m-b-n-sm m-l-sm"> <img src="<?php echo IMG_PATH.'adminloginlogo.png';?>"> <i class="on md b-white bottom"></i>
						...
						<ul class="dropdown-menu animated fadeInRight w">
							...
							<li class="divider"></li>
							<li><a href="<?php echo site_url('adminct/login/logout');?>">安全退出</a></li>
						</ul> <!-- / dropdown --></li>
				</ul>
				<!-- / navbar right -->
			</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form id="pass-modify-form" autocomplete="off">
							...
							<a href="<?php echo site_url("adminct/manager/password")?>" class="btn btn-primary ajaxproxy" proxy='{"formId":"pass-modify-form", "method":"post", "location":"<?php echo site_url('adminct/login/logout')?>"}'>保存修改</a>
						</form>
					</div>
				</div>
				<!-- /.modal-content -->

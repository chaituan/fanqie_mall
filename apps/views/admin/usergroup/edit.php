				...
				<div class="panel-body">
					<form class="form-horizontal" autocomplete="off" id="content_add_form">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="data[gname]" class="form-control" cname="名称" value="<?php echo $item['gname']?>" required>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="data[fans_num]" class="form-control" cname="粉丝数量" value="<?php echo $item['fans_num']?>" required>
							</div>
						</div>
						<div class="line line-dashed b-b line-lg pull-in"></div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="input-group">
									<input type="text" name="data[p_1]" class="form-control" cname="一级" value="<?php echo $item['p_1']?>" required> <span class="input-group-addon">%</span>
								</div>
							</div>
						</div>
						<div class="line line-dashed b-b line-lg pull-in"></div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="input-group">
									<input type="text" name="data[p_2]" class="form-control" cname="二级" value="<?php echo $item['p_2']?>" required>  <span class="input-group-addon">%</span>
								</div>
							</div>
						</div>
						<div class="line line-dashed b-b line-lg pull-in"></div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="data[summary]" class="form-control" placeholder="会员组简介" value="<?php echo $item['summary']?>" required>
							</div>
						</div>
						<div class="line line-dashed b-b line-lg pull-in"></div>
						<div class="form-group">

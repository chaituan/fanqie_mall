					...
					<form class="form-horizontal" autocomplete="off" id="content_add_form">
						<div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <option value="<?php echo $value['tkey']?>" <?php if ($value['tkey']==$groupkey)echo 'selected';?>><?php echo $value['name'];?></option>
                                <?php }?>
                            </select>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
                                ...
                                <?php if(isset($pid)){foreach ($menuData as $value){?>
                                <option value="<?php echo $value['id'];?>" <?php if ($value['id']==$pid)echo 'selected';?>><?php echo $value['name'];?></option>
                                <?php }}?>
                            </select>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<label class="i-switch m-t-xs m-r"> <input type="checkbox" name="data[ishow]" value="1" checked="checked"> <i></i>
								</label>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<a href="<?php echo site_url('adminct/menu/add')?>" class="btn btn-sm btn-primary ajaxproxy" data-loading-text="正在提交……" proxy='{"formId":"content_add_form", "method":"post", "location":"<?php echo site_url('adminct/menu/index')?>"}'>保存修改</a>
							</div>
						</div>
					</form>
				</div>

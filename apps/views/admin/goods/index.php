					...
					<div class="col-sm-3">
						<form action="" method="get">
							<div class="input-group">
								<input type="text" name="name" class="form-control input-sm" value="<?php echo isset($name)?$name:"";?>" placeholder="请输入产品名字" /> <span class="input-group-btn">
						...
						<table class="table table-striped b-t b-light" style="margin-bottom: 0;">
							...
							<tbody>
                                ...
                                <tr>
									...
									<td><a data-src="<?php echo $v['thumb'];?>" class="thumb">查看</a></td>
